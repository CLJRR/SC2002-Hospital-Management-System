 ...
 * Implementing classes must provide a custom implementation of the {@code load} method
...
public interface Load {
     ...
     * @throws IOException if an error occurs while accessing or reading the data source
     */
