...
public class AppointmentOutcomeRecordLoader {
    ...
    /**
     * Service responsible for loading appointment outcome records from a data
     * source.
     */
    private final AppointmentOutcomeRecordService appointmentOutcomeRecordService;

    /**
     * Constructs a new {@code AppointmentOutcomeRecordLoader} with the specified
     * map
     * to store appointment outcome records.
     *
     * @param appointmentOutcomeRecords the map to store loaded appointment outcome
     *                                  records
     */
